...
# 3. rewrite the history on that branch to *only* include staging/src/sigs.k8s.io/apiserver-runtime/internal/sample-apiserver
...
# this command rewrite git history to *only* include staging/src/sigs.k8s.io/apiserver-runtime/internal/sample-apiserver
git filter-branch -f --subdirectory-filter staging/src/sigs.k8s.io/apiserver-runtime/internal/sample-apiserver HEAD
