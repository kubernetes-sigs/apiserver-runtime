...
func autoConvert_v1alpha1_FlunderSpec_To_wardle_FlunderSpec(in *FlunderSpec, out *wardle.FlunderSpec, s conversion.Scope) error {
	...
	// WARNING: in.ReferenceType requires manual conversion: inconvertible types (*sigs.k8s.io/apiserver-runtime/internal/sample-apiserver/pkg/apis/wardle/v1alpha1.ReferenceType vs sigs.k8s.io/apiserver-runtime/internal/sample-apiserver/pkg/apis/wardle.ReferenceType)
	return nil
}
...
func autoConvert_wardle_FlunderSpec_To_v1alpha1_FlunderSpec(in *wardle.FlunderSpec, out *FlunderSpec, s conversion.Scope) error {
	...
	// WARNING: in.ReferenceType requires manual conversion: inconvertible types (sigs.k8s.io/apiserver-runtime/internal/sample-apiserver/pkg/apis/wardle.ReferenceType vs *sigs.k8s.io/apiserver-runtime/internal/sample-apiserver/pkg/apis/wardle/v1alpha1.ReferenceType)
	return nil
}
