	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SampleV1alpha1().Fischers().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SampleV1alpha1().Fischers().Watch(context.TODO(), options)
			},
		},
		&samplev1alpha1.Fischer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fischerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplev1alpha1.Fischer{}, f.defaultInformer)
}
