	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SampleV1alpha1().Flunders(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SampleV1alpha1().Flunders(namespace).Watch(context.TODO(), options)
			},
		},
		&samplev1alpha1.Flunder{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *flunderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplev1alpha1.Flunder{}, f.defaultInformer)
}
