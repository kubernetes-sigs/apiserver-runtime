...
var fischersResource = schema.GroupVersionResource{Group: "sample.k8s.com", Version: "v1alpha1", Resource: "fischers"}

var fischersKind = schema.GroupVersionKind{Group: "sample.k8s.com", Version: "v1alpha1", Kind: "Fischer"}
