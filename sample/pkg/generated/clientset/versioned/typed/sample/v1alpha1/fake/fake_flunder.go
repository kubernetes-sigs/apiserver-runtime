...
var flundersResource = schema.GroupVersionResource{Group: "sample.k8s.com", Version: "v1alpha1", Resource: "flunders"}

var flundersKind = schema.GroupVersionKind{Group: "sample.k8s.com", Version: "v1alpha1", Kind: "Flunder"}
